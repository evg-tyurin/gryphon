...
public class LdapBrowser
{
	...
	/** 
	 * —писок атрибутов, которые запрашиваем из LDAP.
	 * Ќачальный список оставлен дл€ обратной совместимости. 
	 */
	private String[] defRequestedAttrIDs = { "sAMAccountName", "sn", "givenName", "mail", "memberOf" };
	
	/**
	 * Ќазвание атрибута, которое будет записано как uid.
	 * Ќачальное значение оставлено дл€ обратной совместимости.
	 */
	private String defUidAttrID = "sAMAccountName";

	/**
	 * Ќазвание атрибута, из которого будет определ€тьс€ членство в группах.
	 * Ќачальное значение оставлено дл€ обратной совместимости.
	 */
